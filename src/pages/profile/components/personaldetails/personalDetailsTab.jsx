...
const PersonalDetailsTab = ({ profile, onProfileUpdated }) => {
  ...
  const [showPendingAddressModal, setShowPendingAddressModal] =
  useState(false);

const [pendingAddressRequest, setPendingAddressRequest] =
  useState(null);
  ...
  const handleContactChange = (field, value) => {
    ...
    if (
      otpSent &&
      ["mobile", "personalEmail", "maritalStatus"].includes(
        field,
      )
    ) {
      setOtpVerified(false);
  ...
  const handleVerifyOTP = async () => {
    if (!requestId) {
      setContactErrors((prev) => ({
        ...prev,
        otp:
          "OTP request not found. Please resend OTP.",
      }));
    ...
    const otpError = validateContactField(
      "otp",
      contactForm.otp,
    );
...
const handleSubmitAddress = async () => {
  ...
  try {
    ...
    if (
      ...
      console.log(
        "PENDING ADDRESS REQUEST FOUND IN ERROR RESPONSE"
      );
  ...
  const DetailItem = ({
    ...
    <div
      className={
        fullWidth
          ? "col-12 mb-2"
          : "col-xl-6 col-lg-6 col-md-6 col-12 mb-2"
      }
    >
              ...
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      type="text"
                      className={getContactInputClass(
                        "mobile",
                      )}
                      value={
                        contactForm.mobile
                ...
                <div className="mb-3">
                  ...
                  <div className="d-flex align-items-center">
                    <select
                      className={getContactSelectClass(
                        "maritalStatus",
                      )}
                      value={
                        contactForm.maritalStatus
        ...
        <div className="modal-header">
          <div>
            ...
            <small className="text-muted">
              Your previous address change request is
              still pending for authorisation.
            </small>
          </div>
        ...
        <div className="modal-body">
          ...
          <div className="alert alert-warning d-flex align-items-start mb-3">
            ...
            <div>
              ...
              >
                You cannot submit another address change
                request until the existing request is
                authorised or closed.
              </div>
            </div>
          </div>
              ...
              <div className="border rounded p-3 mb-4">
                ...
                <div className="row">
                  ...
                  <div className="col-md-4 mb-2">
                    ...
                    <div className="fw-semibold">
                      {displayValue(
                        pendingAddressRequest.request_id,
                      )}
                    </div>
                  </div>
                  ...
                  <div className="col-md-4 mb-2">
                    ...
                    <div className="fw-semibold">
                      {displayValue(
                        pendingAddressRequest.requested_on,
                      )}
                    </div>
                  </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-header">
                <div>
                  ...
                  <small className="text-muted">
                    Address changes require
                    authorisation and address proof.
                  </small>
                </div>
              ...
              <div className="modal-body">
                ...
                <div className="row">
                  ...
                  <div className="col-12 mb-3">
                    ...
                    <FieldError
                      message={addressErrors.permnt_address}
                    />
                  </div>
                  ...
                  <div className="col-md-4 mb-3">
                    ...
                    <FieldError
                      message={addressErrors.permnt_city}
                    />
                  </div>
                  ...
                  <div className="col-md-4 mb-3">
                    ...
                    <FieldError
                      message={addressErrors.permnt_state}
                    />
                  </div>
                  ...
                  <div className="col-md-4 mb-3">
                    ...
                    <FieldError
                      message={addressErrors.permnt_pincode}
                    />
                  </div>
                ...
                <div className="mb-3">
                  ...
                  <small className="text-muted">
                    Upload address proof in PDF,
                    JPG or PNG format. Maximum
                    size: 1 MB.
                  </small>
