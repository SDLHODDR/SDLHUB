...
import {
  ...
  mapDivisionOptions
} from '../../portalutils/policyOptionsUtils'
...
const PolicyList = () => {
  ...
  const listData = useMemo(() => {
    try {
      return normalizeRecords(policyData).map((item, index) => {
        ...
        const compDesc =
          companyLookup.get(String(item.COMP_NAME ?? '')) ||
          item.COMP_NAME ||
          '-'
  ...
  const columns = useMemo(() => policyColumns({ handleEdit }), [handleEdit])
  ...
  const calendarMinDate = moment().startOf('month').toDate()

  const calendarMaxDate = moment().add(1, 'month').endOf('month').toDate()
    ...
    <>
      <div>
        <div className='page-header' style={{ marginBottom: '8px' }}>
          ...
          <BreadcrumbNav
            items={[{ text: 'Home', link: portalHome }, { text: 'Policy' }]}
          />
        </div>
                  ...
                  <>
                    {isPublished && (
                      <div className='alert alert-info'>
                        This policy is already published and shown for reference
                        only.
                      </div>
                    )}
                      ...
                      <div className='col-lg-3'>
                        <div className='mb-3'>
                          ...
                          <SDLReactSelect
                            ...
                            onChange={val =>
                              handleFieldChange('COMP_NAME', val)
                            }
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-3'>
                        <div className='mb-3'>
                          ...
                          <SDLCalendar
                            value={toCalendarDate(formData.START_DATE)}
                            onChange={date =>
                      ...
                      <div className='col-md-3'>
                        <div className='mb-3'>
                          ...
                          <SDLCalendar
                            value={toCalendarDate(formData.END_DATE)}
                            onChange={date =>
                      ...
                      <div className='col-md-12'>
                        <div className='form-check mb-3'>
                          <input
                            ...
                            onChange={e =>
                              handleFieldChange('IS_MANDAT', e.target.checked)
                            }
                            disabled={isPublished}
                          />
                          <label
